...
- Merge remote-tracking branch 'upstream/protocol' into ownership-provider ([@IronLu233](https://github.com/IronLu233))
- feat(ownership-provider): optimize parseLockScriptLike ([@IronLu233](https://github.com/IronLu233))
...
- feat(ownership-provider): implement signTransaction ([@IronLu233](https://github.com/IronLu233))
- feat(extension-chrome): signTransaction implement ([@IronLu233](https://github.com/IronLu233))
- feat(extension-chrome): add pay fee implement ([@IronLu233](https://github.com/IronLu233))
- feat(extension-chrome): implement `collect` `injectCapacity` ([@IronLu233](https://github.com/IronLu233))
- chore: example for provider ([@homura](https://github.com/homura))
- feat: template of ownership provider ([@homura](https://github.com/homura))
